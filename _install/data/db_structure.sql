...
CREATE TABLE `PREFIX_aeuc_cmsrole_email` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `PREFIX_aeuc_email` (
...
CREATE TABLE `PREFIX_appagebuilder` (
...
CREATE TABLE `PREFIX_appagebuilder_details` (
...
CREATE TABLE `PREFIX_appagebuilder_details_shop` (
  `id_appagebuilder_details` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `PREFIX_appagebuilder_extracat` (
...
CREATE TABLE `PREFIX_appagebuilder_extrapro` (
...
CREATE TABLE `PREFIX_appagebuilder_lang` (
  `id_appagebuilder` int(11) NOT NULL AUTO_INCREMENT,
  `id_lang` int(10) unsigned NOT NULL,
  `params` text,
...
CREATE TABLE `PREFIX_appagebuilder_page` (
  `id_product` int(11) unsigned NOT NULL,
  `id_category` int(11) unsigned NOT NULL,
...
CREATE TABLE `PREFIX_appagebuilder_positions` (
...
CREATE TABLE `PREFIX_appagebuilder_positions_shop` (
  `id_appagebuilder_positions` int(11) NOT NULL AUTO_INCREMENT,
  `id_shop` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id_appagebuilder_positions`,`id_shop`)
) ENGINE=ENGINE_TYPE DEFAULT CHARSET=utf8 COLLATION;

CREATE TABLE `PREFIX_appagebuilder_products` (
...
CREATE TABLE `PREFIX_appagebuilder_products_shop` (
  `id_appagebuilder_products` int(11) NOT NULL AUTO_INCREMENT,
  `id_shop` int(10) unsigned NOT NULL,
  `active` tinyint(1) DEFAULT NULL,
...
CREATE TABLE `PREFIX_appagebuilder_profiles` (
...
CREATE TABLE `PREFIX_appagebuilder_profiles_lang` (
  `id_appagebuilder_profiles` int(11) NOT NULL AUTO_INCREMENT,
  `id_lang` int(10) unsigned NOT NULL,
...
CREATE TABLE `PREFIX_appagebuilder_profiles_shop` (
  `id_appagebuilder_profiles` int(11) NOT NULL AUTO_INCREMENT,
  `id_shop` int(10) unsigned NOT NULL,
  `active` tinyint(1) DEFAULT NULL,
...
CREATE TABLE `PREFIX_appagebuilder_shop` (
  `id_appagebuilder` int(11) NOT NULL AUTO_INCREMENT,
  `id_shop` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id_appagebuilder`,`id_shop`)
) ENGINE=ENGINE_TYPE DEFAULT CHARSET=utf8 COLLATION;

CREATE TABLE `PREFIX_appagebuilder_shortcode` (
  `id_appagebuilder_shortcode` int(11) NOT NULL AUTO_INCREMENT,
  `id_appagebuilder` int(11) unsigned DEFAULT NULL,
  `shortcode_key` varchar(255) NOT NULL,
  `active` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`id_appagebuilder_shortcode`)
) ENGINE=ENGINE_TYPE DEFAULT CHARSET=utf8 COLLATION;

CREATE TABLE `PREFIX_appagebuilder_shortcode_lang` (
...
CREATE TABLE `PREFIX_appagebuilder_shortcode_shop` (
  `id_appagebuilder_shortcode` int(11) unsigned NOT NULL,
  `id_shop` int(10) unsigned NOT NULL,
  `active` tinyint(1) DEFAULT NULL,
...
CREATE TABLE `PREFIX_leofeature_product_review_grade` (
  `id_product_review_grade` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `PREFIX_leoslideshow_groups` (
  ...
  `active_ap` tinyint(1) DEFAULT NULL,
  `randkey` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id_leoslideshow_groups`,`id_shop`)
) ENGINE=ENGINE_TYPE DEFAULT CHARSET=utf8 COLLATION;
...
CREATE TABLE `PREFIX_leoslideshow_slides` (
  ...
  `active` tinyint(1) unsigned NOT NULL DEFAULT '1',
  `params` text NOT NULL,
  PRIMARY KEY (`id_leoslideshow_slides`)
) ENGINE=ENGINE_TYPE DEFAULT CHARSET=utf8 COLLATION;
...
CREATE TABLE `PREFIX_leoslideshow_slides_lang` (
  ...
  `video` text,
  `layersparams` text,
  PRIMARY KEY (`id_leoslideshow_slides`,`id_lang`)
) ENGINE=ENGINE_TYPE DEFAULT CHARSET=utf8 COLLATION;
