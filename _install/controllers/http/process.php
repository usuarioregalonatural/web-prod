...
class InstallControllerHttpProcess extends InstallControllerHttp implements HttpConfigureInterface
{
    ...
    public function processInstallTheme()
    {
        ...
        # LEO_THEME fix correct image of MENU WIDGET
        # HAVE TO CODE HERE, CANNOT WRITE AT $this->model_install
        if (file_exists(_PS_MODULE_DIR_.'appagebuilder/libs/LeoDataSample.php')){
            include_once _PS_MODULE_DIR_.'appagebuilder/libs/LeoDataSample.php';
            if (class_exists('Datasample')) {
                $obj = new Datasample();
                $obj->correctImgLink();
            }
        }
        
        # LEO_THEME FIX REMOVE FILE INDEX.PHP FOR TRANSLATE
        if (file_exists(_PS_MODULE_DIR_.'appagebuilder/libs/setup.php'))
        {
            ...
            ApPageSetup::processTranslateQSTheme();
        }
