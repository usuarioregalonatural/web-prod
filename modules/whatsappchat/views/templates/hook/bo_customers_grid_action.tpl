            ...
            $(document).ready(function(){
                {/literal}{if $show_button !== false}{literal}
                    ...
                    {/literal}{elseif version_compare($smarty.const._PS_VERSION_,'1.6','>=')}{literal}
                        $("#content div.col-lg-7 .panel:first .hidden-print:first").prepend(html);
                    {/literal}{else}{literal}
                        var html = '<a class="toolbar_btn" href="#" onclick="customers_list.openWhatsAppChat();return false;" ><span class="icon-whatsapp bo"><img src="{/literal}{$this_path_bo|escape:'htmlall':'UTF-8'}{literal}views/img/whatsapp-32x32.png" /></span> <div>{/literal}{$action_whatsappchat|escape:'htmlall':'UTF-8'}{literal}</div></a>';
