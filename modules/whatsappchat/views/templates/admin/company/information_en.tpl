...
{$modules[21]=[
    'name' => 'Show products anywhere',
    'id' => '45104',
    'description' => "Show products anywhere in your shop. You can configure which products do you want to show, what will be his audience and where will be shown them in the shop."]
}
