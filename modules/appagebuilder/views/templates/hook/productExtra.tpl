        ...
        <div class="translations tabbable" id="form_tab_hooks_meta_title">
          <div class="translationsFields tab-content">
            {foreach from=$languages item=language}
              <div class="translationsFields-form_tab_hooks_{$apextrak}_{$language.id_lang} tab-pane translation-label-{$language.iso_code} {if $language.id_lang == $default_language.id_lang}active{/if}">
