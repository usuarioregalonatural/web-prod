        ...
        this.setButtonAction = function () {
            ...
            $(document).on("click", ".group-add", function () {
                ...
                // Display popup list Widget for add new a widget
                    ...
                    var url = $globalthis.ajaxShortCodeUrl + '&ajax=1&action=renderList';
                    var data = '';
                    $("#ap_loading").show();
            ...
            $(document).on("click", ".btn-import", function () {
                $("#ap_loading").show();
                var url = $globalthis.ajaxShortCodeUrl + '&ajax=1&action=RenderList&showImportForm=1&idProfile=' + $globalthis.profileId;
                var data = '';
                $.ajax({
                    type: 'POST',
                    headers: {"cache-control": "no-cache"},
