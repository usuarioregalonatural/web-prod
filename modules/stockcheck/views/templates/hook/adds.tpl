...
<div class="panel-heading">
		<i class="icon-picture-o"></i> {l s="Format preview" mod="stockcheck"}
	</div>
<table width="100%" border="0" cellpadding="6" cellspacing="6" >
  <tr>
    <td align="center" valign="middle"><a href="{$module_dir|escape}productlist.php" target="_blank"><img src="{$module_dir|escape}views/img/1.jpg" border="1" alt="{l s='View' mod='stockcheck'}" width="200" title="{l s='View ' mod='stockcheck'}" /></a></td>
...
<div class="bootstrap panel">
<div class="panel-heading">
		<i class="icon-picture-o"></i> {l s="Video" mod="stockcheck"}
	</div>
