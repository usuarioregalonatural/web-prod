...
class Blockgrouptop extends Module implements WidgetInterface
{
    ...
    {
        $this->context->controller->registerStylesheet('modules-blockgrouptop-blockgrouptop', 'modules/blockgrouptop/css/blockgrouptop.css', array('media' => 'all', 'priority' => 150));
        $this->context->controller->registerJavascript('modules-blockgrouptop-blockgrouptop', 'modules/blockgrouptop/js/blockgrouptop.js', array('position' => 'bottom', 'priority' => 150));
    }
