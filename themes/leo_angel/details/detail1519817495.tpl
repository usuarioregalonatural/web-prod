<section id="main" class="product-detail no-thumbs-center product-image-thumbs no-thumbs" itemscope itemtype="https://schema.org/Product">
  <meta itemprop="url" content="{$product.url}"><div class="row"><div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-xs-12 col-sp-12">{block name='page_header_container'}
...
{/block}{block name='hook_display_reassurance'}
  {hook h='displayReassurance'}
{/block}
							</div><div class="col-xl-5 col-lg-6 col-md-6 col-sm-12 col-xs-12 col-sp-12">{block name='page_content_container'}
...
{/block}
							</div><div class="col-xl-3 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-sp-12">{block name='product_prices'}
...
{/if}<div class="product-actions">
  ...
  {/block}
							...
							</div><div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-sp-12">{include file="sub/product_info/accordions.tpl"}{block name='product_accessories'}
      {if $accessories}
