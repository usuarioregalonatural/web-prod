<section id="main" class="product-detail no-thumbs product-image-thumbs no-thumbs" itemscope itemtype="https://schema.org/Product">
  <meta itemprop="url" content="{$product.url}"><div class="row"><div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12 col-sp-12">{block name='page_content_container'}
  <section class="page-content" id="content" data-templateview="none" data-numberimage="5" data-numberimage1200="5" data-numberimage992="4" data-numberimage768="3" data-numberimage576="3" data-numberimage480="2" data-numberimage360="2" data-templatemodal="1" data-templatezoomtype="in">
...
{/block}
							</div><div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12 col-sp-12">{block name='page_header_container'}
...
{/if}<div class="product-actions">
  ...
  {/block}
							...
							</div><div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-sp-12">{block name='hook_display_reassurance'}
  {hook h='displayReassurance'}
{/block}{include file="sub/product_info/tab.tpl"}{block name='product_accessories'}
      {if $accessories}
