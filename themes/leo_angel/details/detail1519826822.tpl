<section id="main" class="product-detail image-gallery product-image-gallery" itemscope itemtype="https://schema.org/Product">
  ...
  <section class="page-content" id="content" data-templatezoomtype="in" data-zoomposition="top" data-zoomwindowwidth="400" data-zoomwindowheight="400">
...
{/block}
							</div><div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-sp-12">{include file="sub/product_info/tab.tpl"}{block name='product_accessories'}
      {if $accessories}
