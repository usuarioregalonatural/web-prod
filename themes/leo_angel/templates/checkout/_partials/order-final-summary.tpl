  ...
  <div class="row">
    <div class="col-md-12">
      ...
      {l s='Addresses' d='Shop.Theme.Checkout'}
        <span class="step-edit step-to-addresses js-edit-addresses"><i class="material-icons edit">&#xE254;</i> {l s='edit' d='Shop.Theme.Global'}</span>
      </h4>
    </div>
  </div>
  <div class="row">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      {l s='Shipping Method' d='Shop.Theme.Checkout'}
        <span class="step-edit step-to-delivery js-edit-delivery"><i class="material-icons edit">&#xE254;</i> {l s='edit' d='Shop.Theme.Global'}</span>
      </h4>
