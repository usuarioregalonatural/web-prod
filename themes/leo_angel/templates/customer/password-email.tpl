  ...
  <form action="{$urls.pages.password}" class="forgotten-password" method="post">
    ...
    <section class="form-fields">
      <div class="form-group center-email-fields row">
        <label class="col-lg-3 col-md-3 form-control-label required">{l s='Email address' d='Shop.Forms.Labels'}</label>
        <div class="col-lg-6 col-md-5 email">
        ...
        <div class="col-lg-3 col-md-3 send">
...
{block name='page_footer'}
  <a href="{$urls.pages.my_account}" class="account-link btn">
